...
const dependencies = {
    '@angular/cdk': version_1.materialVersion,
    '@angular/animations': angularVersion,
    '@angular/common': angularVersion,
    '@angular/compiler': angularVersion,
    '@angular/core': angularVersion,
    '@angular/forms': angularVersion,
    '@angular/material': version_1.materialVersion,
    '@angular/material-moment-adapter': version_1.materialVersion,
 ...
 * }
 */
exports.StackBlitzWriter = (() => {
    let _classDecorators = [(0, core_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var StackBlitzWriter = _classThis = class {
        constructor(_http) {
            this._http = _http;
        }
        /**
        ...
        constructStackBlitzForm(exampleId, data) {
            const liveExample = posts_1.EXAMPLE_COMPONENTS[exampleId];
        ...
        _readFile(form, data, filename, path, prependApp = true) {
            this._http.get(path + filename, { responseType: 'text' }).subscribe(response => this._addFileToForm(form, data, response, filename, path, prependApp), error => console.log(error));
        }
        /**
        ...
        _replaceExamplePlaceholderNames(data, fileName, fileContent) {
            if (fileName === 'src/index.html') {
                ...
                fileContent = fileContent.replace(/{{version}}/g, core_2.VERSION.full);
            }
                ...
                fileContent = fileContent.
                    replace(/declarations: \[MaterialDocsExample]/g, `declarations: [${joinedComponentNames}]`);
                // Replace `entryComponents: [MaterialDocsExample]`
                // will be replaced as `entryComponents: [DialogContent]`
                fileContent = fileContent.
                    replace(/entryComponents: \[MaterialDocsExample]/g, `entryComponents: [${joinedComponentNames}]`);
                ...
                fileContent = fileContent.
                    replace(/bootstrap: \[MaterialDocsExample]/g, `bootstrap: [${data.componentNames[0]}]`);
    ...
    __setFunctionName(_classThis, "StackBlitzWriter");
    (() => {
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name }, null, _classExtraInitializers);
        StackBlitzWriter = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return StackBlitzWriter = _classThis;
})();
